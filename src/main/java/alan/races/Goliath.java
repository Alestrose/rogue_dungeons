...
public class Goliath extends PlayableCharacter implements RaceInterface{
    ...
    public Goliath(String name, String fileName, PlayerClass primaryClass, GIANT_ANCESTRY ancestry) {
    ...
    public Goliath(String name, String fileName, Cell location, PlayerClass primaryClass, GIANT_ANCESTRY ancestry) {
